    ...
    <div class="scene">
        <div class="page-shell">
            ...
            <div class="emp-nav">
                ...
                <a href="documents.php" class="emp-nav-item active">📁 Documents</a>
                <a href="events.php" class="emp-nav-item">📅 Events</a>
            </div>

            <div class="panel">
                <div class="panel-notch"></div>
                <h2 class="panel-title">Company Documents</h2>
                ...
                <div class="item-list">
                    ...
                    <div class="list-item">
                        ...
                        <a href="<?php echo htmlspecialchars($row['filepath']); ?>" download class="action-link" style="max-width:220px;">
